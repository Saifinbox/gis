...
var jsondata = [
       { "NameStore": "KPK", "Latitude": "30.548598", "Longitude": "68.5424013" },
       { "NameStore": "Islamabad", "Latitude": "33.6517231", "Longitude": "72.9247136"},
       { "NameStore": "Sindh", "Latitude": "24.9999192", "Longitude": "66.5042376" },
       { "NameStore": "Punjab", "Latitude": "31.483673", "Longitude": "74.1861189" }];

// map center
var center = new google.maps.LatLng(30.0441401, 70.6206744);
            ...
            // infowindow.iwOuter($('.gm-style-iw'));
              ...
              map.setCenter(marker.getPosition());
				if(marker.dealerId==0)
				{
                    ...
                    parent.document.getElementById('chaman').innerHTML = '0';
				    //alert('0');
                    window.parent.changeGr(0);
				}
				else if (marker.dealerId==1)
				{
				    document.getElementById("test").innerHTML = "1";
				    parent.document.getElementById('chaman').innerHTML = '1';
					//alert('1');
				    window.parent.changeGr(1);
				}
				else if (marker.dealerId == 2) {
				    document.getElementById("test").innerHTML = "2";
				    parent.document.getElementById('chaman').innerHTML = '2';
				    //alert('1');
				    window.parent.changeGr(2);
				}
				else
				{
				    document.getElementById("test").innerHTML = "3";
				    parent.document.getElementById('chaman').innerHTML = '3';
					//alert('2');
				    window.parent.changeGr(3);
				}
